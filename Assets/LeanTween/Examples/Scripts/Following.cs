...
public class Following : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        // Rotate Planet
        var localPos = UnityEngine.Camera.main.transform.InverseTransformPoint(planet.transform.position);
        LeanTween.rotateAround(UnityEngine.Camera.main.gameObject, Vector3.left, 360f, 300f).setPoint(localPos).setRepeat(-1);
    }
